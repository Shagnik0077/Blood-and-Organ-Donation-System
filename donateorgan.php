...
<body>
  ...
  <div class="container">
    <h1>Donate Organ</h1>
    <form id="organDonationForm" method="post" action="donateorgan.php?action=submit" name="organDonateForm">
...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_REQUEST['action']=="submit")
    {
        ...
        $insertQuery = "INSERT INTO t_organ_doner_pending_table VALUES ('', '$name','$email','$organ', '$age', '$gender','$bloodGroup','$hospital','$status','S')";
